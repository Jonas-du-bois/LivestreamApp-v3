...
## 2026-07-07 - Feedback tactile sur les icônes de rafraîchissement
**Learning:** Les icônes statiques lors des actions de rechargement manquent de dynamisme, mais tourner toutes les icônes (ex: home, close) au clic crée une expérience désagréable.
**Action:** Utiliser la classe Tailwind `group` sur le parent et `group-active:rotate-180` avec une transition fluide sur l'enfant, en appliquant cette logique conditionnellement (uniquement si le nom de l'icône contient 'sync' ou 'clockwise').
