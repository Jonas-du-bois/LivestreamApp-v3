...
## 2026-05-26 - Tactile Feedback on Segmented Controls
**Learning:** Native segmented controls or navigation tabs without tactile feedback feel slow on mobile.
**Action:** Always reinforce the feeling of instantaneous reactivity by adding pressure micro-interactions (e.g., `active:scale-95` and `duration-200` color transitions) to interactive navigation elements.
