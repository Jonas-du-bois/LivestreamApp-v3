...
## 2024-04-02 - Feedback tactile sur les boutons d'actualisation
**Learning:** Les boutons d'actualisation manquent souvent de retour visuel sur l'icône lors d'un clic.
**Action:** Utiliser les classes `group` et `group-active:rotate-180` avec `duration-200` sur l'icône à l'intérieur du composant bouton pour un feedback immédiat sans toucher au JavaScript.
