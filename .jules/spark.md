...
## 2026-06-30 - Interaction de rafraîchissement (Pull-to-refresh visuel)
**Learning:** L'utilisation de `group` et `group-active:rotate-180` sur les boutons génériques nécessite de cibler spécifiquement les icônes de rafraîchissement ("sync", "refresh") pour éviter d'animer des icônes statiques (ex: "home").
**Action:** Appliquer systématiquement cette condition sur les composants réutilisables comme `UiButton` ou `UiIconButton`.
