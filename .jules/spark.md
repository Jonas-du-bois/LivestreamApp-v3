...
## 2026-05-18 - Feedback tactile sur les sélecteurs de tours
**Learning:** Les boutons de sélection d'onglets (comme Qualifications/Finales) manquent souvent de feedback immédiat sur mobile, ce qui donne une impression de lenteur de l'UI.
**Action:** Toujours ajouter `active:scale-95 duration-200` sur ces petits éléments interactifs pour simuler la pression physique et améliorer la réactivité perçue sans décaler le layout.
