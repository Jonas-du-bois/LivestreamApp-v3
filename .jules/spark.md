...
## 2025-05-18 - Feedback tactile sur le bouton de réinitialisation des filtres
**Learning:** Les boutons isolés comme la réinitialisation des filtres ("Empty State") gagnent énormément en "jus" avec un simple état `group` permettant de faire tourner leur icône interne sur le `group-active`.
**Action:** Utiliser `group-active:-rotate-180` avec une transition de 300ms sur les icônes de rafraîchissement/réinitialisation pour un feedback tactile satisfaisant sans alourdir le DOM.
