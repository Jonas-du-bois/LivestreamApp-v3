...
## 2026-06-28 - Feedback tactile sur les cartes statiques
**Learning:** J'ai remarqué que les cartes purement informatives, même si elles ne sont pas des liens, paraissent "mortes" au toucher. En ajoutant un léger `active:scale-[0.98]` ou la prop `interactive`, l'application gagne en réactivité.
**Action:** Toujours ajouter un léger scale (0.98) sur les cartes statiques avec du contenu important pour simuler une pression au doigt.
