...
## 2026-06-06 - Feedback tactile sur les contrôles segmentés
**Learning:** Native segmented controls or navigation tabs without tactile feedback feel slow on mobile.
**Action:** Always reinforce the feeling of instantaneous reactivity by adding pressure micro-interactions (e.g., `active:scale-95`) to interactive navigation elements like the Qualifications/Finales round selectors.
