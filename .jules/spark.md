...
## 2026-06-27 - Rotation tactile des boutons d'action
**Learning:** Les boutons avec uniquement une icône manquent de feedback lors du pull-to-refresh ou de la synchronisation manuelle.
**Action:** J'ai ajouté l'interaction `group-active:rotate-180` et `duration-500` sur l'icône de `UiIconButton` pour donner une sensation de synchronisation fluide sans bloquer l'UI principale.
