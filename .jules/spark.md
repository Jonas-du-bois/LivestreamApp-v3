...
## 2026-05-29 - Feedback tactile sur les contrôles de navigation
**Learning:** Les petits boutons de contrôle natifs (comme les sélecteurs de tabs/rounds) nécessitent un retour visuel instantané au toucher sur mobile pour ne pas paraître lents.
**Action:** Toujours ajouter `active:scale-95 duration-200` (et éventuellement `active:bg-white/5`) sur ces éléments d'interface pour renforcer le sentiment de réactivité immédiate.
