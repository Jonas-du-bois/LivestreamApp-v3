...
## 2024-05-16 - Tactile feedback on segmented controls
**Learning:** Native segmented controls or navigation tabs without tactile feedback feel slow on mobile.
**Action:** Always reinforce the feeling of instantaneous reactivity by adding pressure micro-interactions (e.g., `active:scale-95` and `duration-200` color transitions like `active:bg-white/5`) to interactive navigation elements.
