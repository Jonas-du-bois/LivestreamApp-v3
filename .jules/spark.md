...
## 2026-06-14 - [Feedback tactile sur la sélection des rounds]
**Learning:** [Les boutons de sélection de rounds (Qualifications / Finales) dans results.vue manquaient de feedback tactile, ce qui les rendait moins réactifs sur mobile.]
**Action:** [Ajout des classes Tailwind `active:scale-95 duration-200` aux boutons pour donner un effet d'enfoncement satisfaisant au toucher, améliorant ainsi la perception de réactivité de l'interface.]
