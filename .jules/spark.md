...
## 2026-05-07 - Feedback tactile sur le sélecteur de manches
**Learning:** Les boutons de sélecteur de manches (Qualifications/Finales) manquaient de retour visuel lors d'un appui tactile.
**Action:** Ajout de la classe `active:scale-95` sur les boutons pour offrir une sensation de réactivité immédiate sans utiliser de JavaScript complexe ou de librairie d'animation.
