...
## 2026-06-22 - Segmented Control Tactile Feedback
**Learning:** Native segmented controls or navigation tabs without tactile feedback feel slow and unresponsive on mobile devices.
**Action:** Always reinforce the feeling of instantaneous reactivity by adding pressure micro-interactions (e.g., `active:scale-95` and `duration-200` color transitions like `active:bg-white/5`) to interactive navigation elements, particularly in custom segmented controls.
