...
## 2026-05-14 - Feedback tactile sur le toggle Qualifications/Finales
**Learning:** Les segmented controls (boutons de bascule) natifs sans feedback tactile paraissent lents ou non-réactifs sur mobile. L'ajout d'une micro-interaction de pression renforce le ressenti de réactivité instantanée de l'application.
**Action:** Toujours ajouter `active:scale-95` et des transitions de couleur (`duration-200`) sur les éléments de navigation interactifs comme les onglets ou les bascules de vue.
