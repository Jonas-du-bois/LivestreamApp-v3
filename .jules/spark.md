...
## 2026-06-17 - Segmented Control Feedback
**Learning:** Native segmented controls or tabs without tactile feedback feel unresponsive on mobile devices.
**Action:** Always add `active:scale-95 duration-200` and a subtle background change like `active:bg-white/5` to tab buttons to reinforce the feeling of instantaneous reactivity.
