...
## 2026-06-12 - Feedback tactile sur les boutons de navigation ronds

**Learning:** J'ai remarqué que les contrôles segmentés et les onglets de navigation natifs sans retour tactile ("Qualifications", "Finales" dans `results.vue`) peuvent sembler lents ou peu réactifs sur mobile.
**Action:** Toujours ajouter `active:scale-95` (et idéalement des transitions de durée comme `duration-200`) aux boutons de navigation ou contrôles segmentés pour simuler la pression du doigt et rendre l'interface plus premium et immédiate.
