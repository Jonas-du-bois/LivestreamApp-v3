...
## 2026-06-18 - Nuxt 3 Global Intl Formatter Caching
**Learning:** In Vue 3 and Nuxt, defining caches (like a Map for Intl.DateTimeFormat) inside a composable function causes the cache to be re-initialized per component instance, wasting memory and CPU cycles.
**Action:** Always declare application-wide caches outside the exported composable function in the module scope to ensure they act as true singletons across the app.
