...
**LiveStreamApp FSG** est une plateforme moderne et performante conçue pour le suivi en temps réel d'événements sportifs. Développée avec **Nuxt 4**, elle offre une expérience fluide tant sur le web (PWA) que sur mobile (Android & iOS via Capacitor).
