...
\n## 2026-03-14 - Double retour tactile\n**Learning:** Les boutons avec icône gagnent énormément en ressenti premium lorsqu'ils intègrent une animation combinée sur le conteneur et sur l'icône, créant un 'double retour tactile' satisfaisant.\n**Action:** Toujours utiliser la classe 'group' sur le conteneur du bouton pour pouvoir animer les éléments enfants avec 'group-active:'. Appliquer des rotations (-rotate-180) pour les icônes de synchronisation, ou des mises à l'échelle (scale-90) / translations pour les autres icônes.\n
