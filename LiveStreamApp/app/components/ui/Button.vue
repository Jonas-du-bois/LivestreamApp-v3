...
<template>
  ...
  >
    ...
    <Icon
      ...
      :name="icon"
      :size="size === 'sm' ? '16' : '20'"
      :class="icon?.includes('sync') || icon?.includes('clockwise') || icon?.includes('refresh') ? 'transition-transform duration-500 group-active:rotate-180' : ''"
    />
    ...
    <Icon
      ...
      :name="iconRight"
      :size="size === 'sm' ? '16' : '20'"
      :class="iconRight?.includes('sync') || iconRight?.includes('clockwise') || iconRight?.includes('refresh') ? 'transition-transform duration-500 group-active:rotate-180' : ''"
    />
  </component>
</template>
