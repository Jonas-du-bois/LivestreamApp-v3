...
const commonClasses = computed(() => [
  'group ui-button app-focus-ring relative isolate overflow-hidden inline-flex items-center justify-center gap-2 transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:pointer-events-none',
...
<template>
  ...
  >
    ...
    <Icon
      ...
      :name="icon"
      :size="size === 'sm' ? '16' : '20'"
      :class="{ 'transition-transform duration-500 group-active:rotate-180': icon.includes('sync') || icon.includes('refresh') }"
    />
