...
<template>
  ...
  >
    ...
    <Icon
      ...
      :class="[icon.includes('sync') || icon.includes('clockwise') || icon.includes('reset') ? 'group-active:rotate-180' : 'group-active:scale-90']"
    />
    ...
    <Icon
      ...
      :size="size === 'sm' ? '16' : '20'"
      class="transition-transform duration-500"
      :class="[iconRight.includes('sync') || iconRight.includes('clockwise') || iconRight.includes('reset') ? 'group-active:rotate-180' : 'group-active:scale-90']"
    />
  </component>
</template>
