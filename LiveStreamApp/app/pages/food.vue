  ...
  <div class="px-4 space-y-6 pb-6">
    ...
    >
      <UiMediaCard
        ...
        variant="split"
        :interactive="true"
        class="premium-cascade-item rounded-2xl bg-gray-900/40 backdrop-blur-xl border-white/10 shadow-xl hover:border-emerald-400/30 hover:shadow-emerald-900/20 active:border-emerald-400/60 active:bg-gray-800/60 active:scale-95 active:backdrop-blur-2xl transition-all duration-200 cursor-pointer"
...
const foodSpots = computed(() => [
  ...
  },
  {
    ...
    name: 'Nomad',
    type: 'Food Truck',
    description: 'Burgers et tacos généreux en version classique, gourmande ou végétarienne, avec frites.',
    icon: 'fluent:vehicle-truck-24-filled',
    isOpen: true,
    image: 'livestreamapp/food/food-3',
    menu: [
      { item: 'Menu Classic (burger / tacos 1 viande + frites)', price: '15.-' },
      { item: 'Menu Gourmand (double burger / tacos 2 viandes + frites)', price: '18.-' },
      { item: 'Menu Végétarien (burger / tacos falafel + frites)', price: '16.-' },
      { item: 'Burger simple',        price: '12.-' },
      { item: 'Tacos 1 viande',       price: '12.-' },
      { item: 'Double Burger',        price: '15.-' },
      { item: 'Tacos 2 viandes',      price: '15.-' },
      { item: 'Burger Végétarien',    price: '13.-' },
      { item: 'Tacos Végétarien',     price: '13.-' },
      { item: 'Portion de frites',    price: '6.-'  },
    ],
  },
