          ...
          <div v-if="(resultsResponse?.meta?.hasFinals || selectedRound === 'FINAL') && selectedDay?.toLowerCase() !== 'dimanche'" class="flex justify-center">
            <div class="glass-card p-1 rounded-full flex gap-1 border border-white/5 bg-white/5">
              <button
                ...
                :class="selectedRound === 'QUALIFIER' ? 'bg-white/10 text-white' : 'text-white/40 hover:text-white/60 active:bg-white/5 active:text-white/80'"
              >
                Qualifications
              </button>
              <button
                ...
                class="px-4 py-1.5 rounded-full text-xs font-bold transition-all duration-200 active:scale-95"
                :class="selectedRound === 'FINAL' ? 'bg-orange-500/20 text-orange-300 border border-orange-500/20' : 'text-white/40 hover:text-white/60 active:bg-white/5 active:text-white/80'"
              >
                Finales
              </button>
            </div>
