    ...
    <Transition name="premium-swap" mode="out-in">
      ...
      <div v-else-if="error" key="weather-error" class="glass-card p-8 text-center">
        ...
        <UiButton variant="secondary" @click="handleRefresh" class="mx-auto group">
          <Icon name="fluent:arrow-clockwise-24-regular" class="w-5 h-5 transition-transform duration-200 group-active:rotate-180" />
          ...
          <div class="relative p-6">
            <div class="flex items-start justify-between gap-4">
              ...
              <UiButton
                ...
                @click="handleRefresh"
              >
                <Icon v-if="!isRefreshing" name="fluent:arrow-clockwise-24-regular" class="w-4 h-4 transition-transform duration-200 group-active:rotate-180" />
