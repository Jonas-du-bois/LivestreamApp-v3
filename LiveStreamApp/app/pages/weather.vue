    ...
    <Transition name="premium-swap" mode="out-in">
      ...
      <div v-else-if="error" key="weather-error" class="glass-card p-8 text-center">
        ...
        <UiButton variant="secondary" @click="handleRefresh" class="mx-auto group">
          <Icon name="fluent:arrow-clockwise-24-regular" class="transition-transform duration-200 group-active:rotate-180" size="20" />
            ...
            <div class="flex items-start justify-between gap-4">
              ...
              >
                <Icon
                  ...
                  class="transition-transform duration-200 group-active:rotate-180"
                  size="16"
                />
