        ...
        <div v-else key="schedule-content">
          <Transition name="fade" mode="out-in">
            ...
            >
              <template #actions>
                <button
                  class="group app-focus-ring app-focus-ring-secondary inline-flex items-center gap-2 rounded-full gradient-cyan-purple px-6 py-2.5 text-sm font-bold text-white transition-all duration-300 hover:opacity-90 hover:shadow-lg hover:shadow-cyan-500/20 active:scale-95"
                  type="button"
