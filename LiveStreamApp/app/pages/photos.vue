        ...
        <template #actions>
          <button
            ...
            class="app-focus-ring flex items-center gap-2 px-5 py-2.5 rounded-xl bg-cyan-500/15 border border-cyan-400/30
                   text-cyan-300 text-sm font-semibold duration-200 active:scale-95 transition-all
                   hover:bg-cyan-500/25"
            @click="refresh()"
          >
            <Icon name="fluent:arrow-sync-24-regular" class="w-4 h-4 transition-transform duration-500" :class="{ 'animate-spin': pending }" />
