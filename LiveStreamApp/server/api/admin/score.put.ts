...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    // Compute rank among published passages (per apparatus)
    // ⚡ BOLT: Optimization - Replaced O(N) find/sort/findIndex with O(1) indexed countDocuments
    // This dramatically reduces memory usage and processing time by letting the database do the work.
