...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    // BOLT: Optimize ranking calculation to avoid O(N) memory bottleneck and DB transfer overhead.
    // Standard competition ranking (1, 2, 2, 4) where tied participants share the same rank.
