...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    // BOLT: Optimize numeric ranking calculation by using .countDocuments() instead of loading all IDs into memory.
    // This prevents O(N) memory scaling and handles ties consistently without returning large arrays.
